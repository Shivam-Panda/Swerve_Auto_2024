...
public class SwerveModule {
    ...
    public SwerveModuleState getState(){
        return new SwerveModuleState(
            Conversions.falconToMPS(mDriveMotor.getSelectedSensorVelocity(), SwerveMap.wheelCircumference, SwerveMap.driveGearRatio), 
            getAngle()
        ); 
    }
    ...
    public SwerveModulePosition getPosition(){
        return new SwerveModulePosition(
            Conversions.falconToMeters(mDriveMotor.getSelectedSensorPosition(), SwerveMap.wheelCircumference, SwerveMap.driveGearRatio), 
            getAngle()
        );
    }
}